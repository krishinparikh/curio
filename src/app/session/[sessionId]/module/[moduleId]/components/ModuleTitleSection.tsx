...
export function ModuleTitleSection({ sessionId, moduleId, isPaneOpen, onTogglePane }: ModuleTitleSectionProps) {
      ...
      <div className="w-full max-w-4xl px-6">
        <div className="pt-4 pb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-4">
          ...
          <div className="flex flex-row items-center gap-2 shrink-0">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button onClick={onTogglePane} variant="outline" className="rounded-lg hover:bg-secondary hover:text-secondary-foreground h-8 md:h-10 px-3 gap-2 text-xs md:text-sm">
